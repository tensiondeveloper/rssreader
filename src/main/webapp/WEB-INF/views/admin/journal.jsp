...
<div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">저널</h6>
            </div>
            <div class="card-body">
					...
					<tbody>
						 <c:forEach var="list" items="${list}" varStatus="status">				
							<tr>
								...
								<td><a href="commu_rewrite?seq=${list.journal_seq}">${list.journal_title}</a></td>
								<td >${list.id}</td>
								<td class="thide">${list.journal_file}</td>
								<td class="thide"><button onclick="delete_board('${list.journal_seq}')">삭제</button></td>
							</tr>
						</c:forEach> 
					</tbody>	
