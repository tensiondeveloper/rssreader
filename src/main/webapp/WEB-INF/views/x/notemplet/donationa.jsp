...
<style type="text/css">
.pungdiv{
padding:10px;border: 1px solid black;width: 250px;margin: 0 auto;    text-align: center;
...
a:hover, a:focus{
	    text-decoration: none;
			...
			<div
				...
				<ol class="breadcrumb">
					...
					<li class="active active ftbold">MBA총동창회 기여현황, 평생회비 납부자</li>
				</ol>

				<h2 class="page-title">MBA총동창회 기여현황, 평생회비 납부자</h2>
				...
				<div class="col-md-12 donaintro" style="margin-bottom: 15px;">
					...
					<div class="col-md-2 active"><a href="/donation?group=1"><h3>평생회비 납부자</h3></a></div>
    ...
    background-size: contain;">
			 ...
			 <img src="/resources/img/donation/pung.png" class="donatxt">
			 
			 <div >
				 
					<c:forEach var="dona" items="${dona_list}" varStatus="status">
				 		<div class="col-sm-6 col-md-4 pungdivr">
					 		<div class="pungdiv">
					 			<span>홍길동 / 90기</span>
					 		</div>
					 	</div>			 
