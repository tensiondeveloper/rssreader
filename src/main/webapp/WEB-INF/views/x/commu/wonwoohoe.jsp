...
$(function(){
$( '.nav-stacked > li:nth-child(10)' ).addClass("active")
})
...
function searchfn(){
	...
	location.href = "wonwoohoe?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "wonwoohoe?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">재학생원우회</li>
					</ol>

					<h2 class="page-title">재학생원우회</h2>
				</div>
