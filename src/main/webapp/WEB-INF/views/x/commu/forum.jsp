...
function searchfn(){
	...
	location.href = "forum?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "forum?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">MBA 포럼</li>
					</ol>

					<h2 class="page-title">MBA 포럼</h2>
				</div>
