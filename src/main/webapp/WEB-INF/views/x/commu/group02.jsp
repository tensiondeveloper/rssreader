...
function searchfn(){
	...
	location.href = "group02?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "group02?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div class="col-md-4 col-sm-6"><div class="unit_div active"  onclick="location.href = 'group02'">그룹2</div></div>
