...
$(function(){
$( '.nav-stacked > li:nth-child(9)' ).addClass("active")
})
...
function searchfn(){
	...
	location.href = "group01?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "group01?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">그룹별 활동</li>
					</ol>

					<h2 class="page-title">그룹별 활동</h2>
				</div>
				<div class="separator-2 clear"></div>
				<!-- page-title end -->
				<div class="col-md-4 col-sm-6"><div class="unit_div active" onclick="location.href = 'group01'">이수회</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div"  onclick="location.href = 'group02'">그룹2</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div" onclick="location.href = 'group03'">그룹3</div></div>
					...
					<tbody>
						<c:forEach var="list" items="${list}" varStatus="status">				
							<tr>
								...
								<td><a href="/commu/board?seq=${list.board_seq}">${list.board_title}</a></td>
								<td >${list.id}</td>
