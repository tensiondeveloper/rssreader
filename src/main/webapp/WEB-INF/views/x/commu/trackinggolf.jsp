...
function searchfn(){
	...
	location.href = "trackinggolf?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "trackinggolf?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">MBA 트레킹/골프</li>
					</ol>

					<h2 class="page-title">MBA 트레킹/골프</h2>
				</div>
