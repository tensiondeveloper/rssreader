...
function searchfn(){
	...
	location.href = "graduatenews?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "graduatenews?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">경영전문대학원,학부 소식</li>
					</ol>

					<h2 class="page-title">경영전문대학원,학부 소식</h2>
				</div>
