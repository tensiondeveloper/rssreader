...
$(function(){
$( '.nav-stacked > li:nth-child(8)' ).addClass("active")
...
function searchfn(){
	...
	location.href = "unit03?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "unit03?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">기수별 활동</li>
					</ol>

					<h2 class="page-title">기수별 활동</h2>
				</div>
				<div class="separator-2 clear"></div>
				<!-- page-title end -->
				<div class="col-md-4 col-sm-6"><div class="unit_div" onclick="location.href = 'unit01'">94기</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div"  onclick="location.href = 'unit02'">96기</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div active" onclick="location.href = 'unit03'">97기</div></div>
