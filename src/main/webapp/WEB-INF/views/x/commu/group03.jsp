...
function searchfn(){
	...
	location.href = "group03?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "group03?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<!-- page-title end -->
				<div class="col-md-4 col-sm-6"><div class="unit_div " onclick="location.href = 'group01'">이수회</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div"  onclick="location.href = 'group02'">그룹2</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div active" onclick="location.href = 'group03'">그룹3</div></div>
