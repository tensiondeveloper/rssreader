...
function searchfn(){
	...
	location.href = "unit02?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "unit02?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div class="col-md-4 col-sm-6"><div class="unit_div" onclick="location.href = 'unit01'">94기</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div active"  onclick="location.href = 'unit02'">96기</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div" onclick="location.href = 'unit03'">97기</div></div>
