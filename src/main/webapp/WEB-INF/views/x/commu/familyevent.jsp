...
function searchfn(){
	...
	location.href = "familyevent?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "familyevent?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">MBA동정/경.조사</li>
					</ol>

					<h2 class="page-title">MBA동정/경.조사</h2>
				</div>
