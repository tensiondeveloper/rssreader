...
function goList(page)
{
	location.href = "notice?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
			...
			<div
				...
				<!-- page-title end -->
				<div class="col-md-4 col-sm-6"><div class="unit_div" id="unit98" onclick="location.href = 'unitactive?unit=98'">98기</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div" id="unit97" onclick="location.href = 'unitactive?unit=97'">97기</div></div>
				<div class="col-md-4 col-sm-6"><div class="unit_div" id="unit96" onclick="location.href = 'unitactive?unit=96'">96기</div></div>
