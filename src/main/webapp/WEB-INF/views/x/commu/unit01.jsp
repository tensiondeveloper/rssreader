...
function searchfn(){
	...
	location.href = "unit01?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "unit01?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<!-- page-title end -->
				<div class="col-md-4 col-sm-6"><div class="unit_div active" onclick="location.href = 'unit01'">94기</div></div>
