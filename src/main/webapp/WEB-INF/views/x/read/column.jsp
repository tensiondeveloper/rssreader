...
function searchfn(){
	...
	location.href = "column?page=0&search="+$("#search").val()+"&keyword="+$("#keyword").val();
...
{
	location.href = "column?page="+page+"&search="+'${search}'+"&keyword="+'${keyword}';
}
			...
			<div
				...
				<div>
					<ol class="breadcrumb">
						...
						<li class="active active ftbold">동문 컬럼/논문</li>
					</ol>

					<h2 class="page-title">동문 컬럼/논문</h2>
				</div>
